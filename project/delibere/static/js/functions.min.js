...
//	n > 80 ? (jQuery(".navbar.navbar-default").addClass("scrolled")) : (jQuery(".navbar.navbar-default").removeClass("scrolled"));
	n > 100 ? (jQuery("#page").addClass("scrolled")) : (jQuery("#page").removeClass("scrolled"));
	});
